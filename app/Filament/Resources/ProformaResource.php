...
class ProformaResource extends Resource
{
    ...
    protected static ?string $pluralLabel = 'Proforma';
                ...
                Grid::make(4)
                    ->schema([
                        Select::make('document_type')
                            ...
                            ->dehydrated(true) // 👈 Force saving to DB
                            ->required()
                            ->default('proforma') // default selected option
    ...
    /**
     * Show Only Document Proforma
     */

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('document_type', 'proforma'); // Only invoices
    }
            ...
            ->actions([
                ...
                Action::make('generateAndViewDocument')
                    ...
                    ->modalContent(function ($record) {
                        // 1) Fetch template
                        $template = DocumentTemplate::find(10);
